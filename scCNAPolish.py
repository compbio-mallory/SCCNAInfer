...
def run_aneufinder(bw, binw):
  ...
  cmd = cmd = "python " + src_path + "/scripts/scPloidy.py " +  " -cov " + out + "_Aneufinder_reads.tsv -CN " + out + "_Aneufinder_cnv.tsv -path " + an_dir  + " -gc gc_map_hg19.tsv  -out " + out + " -ref " + ref
  cmd = cmd + " -minP " + minP + " -maxP " + maxP + " -K " + K + " -s " + s + " -norm "  + norm 
  os.system(cmd) 
...
def run_ginkgo(gp, gbin):
  ...
  cmd = cmd = "python " + src_path + "/scripts/scPloidy.py " +  " -cov " + ginkgo_dir + out + "_Ginkgo_reads.tsv " +  " -CN SegCopy -path " + ginkgo_dir  + " -gc gc_map_hg19.tsv  -out " + out + " -ref " + ref
  cmd = cmd + " -minP " + minP + " -maxP " + maxP + " -K " + K + " -s " + s + " -norm "  + norm
  os.system(cmd)
